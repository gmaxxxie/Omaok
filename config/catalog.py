...
ACTION_DESCRIPTIONS = {
    ...
    "set_nightlight": "Enable/disable/toggle the night-light (warm screen)",
    "set_bluetooth": "Turn Bluetooth on/off/toggle",
    "set_wifi": "Turn Wi-Fi on/off/toggle",
    "set_touchpad": "Enable/disable/toggle the touchpad",
    "toggle_dnd": "Toggle do-not-disturb notifications",
    "toggle_mic": "Toggle microphone mute",
    "toggle_bar": "Show/hide the top bar",
    "open_clipboard": "Open the clipboard manager",
    "open_emoji": "Open the emoji picker",
    "set_reminder": "Set a desktop notification reminder (minutes + message)",
    "brightness_up": "Raise display brightness",
    "brightness_down": "Lower display brightness",
    "set_power_mode": "Set power profile (power-saver/balanced/performance)",
    "shutdown": "Shut down the computer",
    "reboot": "Reboot the computer",
    "logout": "Log out of the session",
    "screen_record_start": "Start a fullscreen screen recording",
    "screen_record_stop": "Stop the active screen recording",
}
